...
main() async {
  ...
  print("Load data in ${sw.elapsedMilliseconds} ms");
  sw.reset();

  var network = buildNetwork();

  print("Build model in ${sw.elapsedMilliseconds} ms");
  sw.reset();
  ...
  new Session(network["model"])
    ..asDefault((session) {
      ...
      print("Initialized variables in ${sw.elapsedMilliseconds} ms");
      sw.reset();
      ...
      print("Loss in ${sw.elapsedMilliseconds} ms");
      sw.reset();
